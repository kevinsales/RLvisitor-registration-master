...
class AteneoAffiliatedForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['aaVisitorID', 'aaType', 'aaYear', 'aaIDPhoto', 'aaCourse', 'aaLastSem', 'aaPaymentConfirmation']
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)   
...
class NonAteneoAffiliatedForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['naaVisitorID', 'naaType', 'naaCompanions', 'naaInvitation', 'naaPaymentConfirmation']
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)   
